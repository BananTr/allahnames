import 'package:allahnames/cardathkar.dart';
import 'package:flutter/material.dart';
class Athkar extends StatefulWidget {
  const Athkar({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title:
         Text('الأذكار', textAlign: TextAlign.center,),
         ),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" أذكار الصباح والمساء " , style: TextStyle(color: Colors.white),),),             
            ],
          ),
            GridView.builder(
              itemCount: athkartext.length ,
            ...
            shrinkWrap: true,
             ...
             itemBuilder: (context,i){
              ...
              InkWell(
                onTap: () {
               Navigator.of(context).push(MaterialPageRoute(builder: (context)=> CardAthkar() ));
                },
                child: Container(
                  child:
                   Card.outlined(
                  ...
                  Column(
                    children:[
                      Padding(
                        ...
                        child: Text("${athkartext[i]["text"]}",textDirection: TextDirection.rtl,),
                      ),
                   ],
                   ),
                 ),
              ...
              Container(
                margin: EdgeInsets.all(10),
                 ...
                 decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10) ),
                child: Text("أذكار النوم " , style: TextStyle(color: Colors.white),),),             
            ],
          ),
       
             GridView.builder(
              itemCount:athkartexlsleeping.length ,
              physics: NeverScrollableScrollPhysics(),
            shrinkWrap: true,
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1), 
             itemBuilder: (context,i){
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("${athkartexlsleeping[i]["text"]} ", textDirection: TextDirection.rtl,),
                    ),
                  ),
                  )
                               ],
